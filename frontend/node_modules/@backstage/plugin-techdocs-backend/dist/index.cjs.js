...
const checkoutGitRepository = async (repoUrl) => {
  ...
  if (fs.existsSync(repositoryTmpPath)) {
    ...
    await repository.mergeBranches(parsedGitLocation.ref, `origin/${parsedGitLocation.ref}`);
...
class LocalPublish {
  ...
  publish({
    ...
    const publishDir = path2.resolve(__dirname, "../../../../static/docs/", entity.kind, entityNamespace, entity.metadata.name);
