 ...
 */
declare function createDatabase(config: ConfigReader, overrides?: Partial<knex.Config>): knex<any, unknown[]>;
...
export { AuthenticationError, ConflictError, ErrorHandlerOptions, InputError, NotAllowedError, NotFoundError, ServiceBuilder, StatusCheck, StatusCheckHandlerOptions, createDatabase, createServiceBuilder, createStatusCheckRouter, errorHandler, getRootLogger, getVoidLogger, loadBackendConfig, notFoundHandler, requestLoggingHandler, setRootLogger, statusCheckHandler, useHotCleanup, useHotMemoize };
