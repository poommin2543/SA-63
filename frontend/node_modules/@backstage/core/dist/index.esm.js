import privateExports__default, { ApiRegistry, defaultSystemIcons, useApi, alertApiRef, errorApiRef, storageApiRef, oauthRequestApiRef, appThemeApiRef, SessionState, identityApiRef, configApiRef, googleAuthApiRef, microsoftAuthApiRef, githubAuthApiRef, gitlabAuthApiRef, oktaAuthApiRef, oauth2ApiRef, useApiHolder } from '@backstage/core-api';
...
function SidebarUserSettings() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(UserProfile, {
    ...
    icon: Star2
  }), providers.includes("microsoft") && /* @__PURE__ */ React.createElement(OIDCProviderSettings, {
    title: "Microsoft",
