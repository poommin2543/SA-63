 ...
 */
declare const microsoftAuthApiRef: ApiRef<OAuthApi & OpenIdConnectApi & ProfileInfoApi & BackstageIdentityApi & SessionStateApi>;
/**
...
declare class MicrosoftAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$6): MicrosoftAuth;
    sessionState$(): Observable<SessionState>;
    constructor(sessionManager: SessionManager<MicrosoftSession>);
    getAccessToken(scope?: string | string[], options?: AuthRequestOptions): Promise<string>;
    getIdToken(options?: AuthRequestOptions): Promise<string>;
    logout(): Promise<void>;
    getBackstageIdentity(options?: AuthRequestOptions): Promise<BackstageIdentity | undefined>;
...
export { AlertApi, AlertApiForwarder, AlertMessage, AnyApiRef, ApiFactory, ApiHolder, ApiProvider, ApiRef, ApiRefConfig, ApiRefType, ApiRefsToTypes, ApiRegistry, ApiTestRegistry, Apis, AppComponents, AppConfigLoader, AppOptions, AppTheme, AppThemeApi, AppThemeSelector, Auth0Auth, Auth0Session, AuthProvider, AuthRequestOptions, AuthRequester, AuthRequesterOptions, BackstageApp, BackstageIdentity, BackstageIdentityApi, BackstagePlugin, BootErrorPageProps, ConfigApi, CreateStorageApiOptions, ErrorAlerter, ErrorApi, ErrorApiForwarder, ErrorContext, FeatureFlagName, FeatureFlagOutput, FeatureFlagState, FeatureFlags, FeatureFlagsApi, GithubAuth, GithubSession, GitlabAuth, GitlabSession, GoogleAuth, GoogleSession, GroupIcon, IconComponent, IdentityApi, LegacyRedirectRouteOutput, LegacyRouteOutput, MicrosoftAuth, MicrosoftSession, MutableRouteRef, OAuth2, OAuth2Session, OAuthApi, OAuthRequestApi, OAuthRequestManager, OAuthScope, Observable, Observer, OktaAuth, OktaSession, OpenIdConnectApi, PendingAuthRequest, PluginOutput, ProfileInfo, ProfileInfoApi, RedirectRouteOutput, RouteOptions, RouteOutput, RoutePath, RouteRef, RouteRefConfig, RouteRefOverrideConfig, SessionState, SessionStateApi, SignInPageProps, SignInResult, StorageApi, StorageValueChange, Subscription, SystemIconKey, SystemIcons, TypesToApiRefs, UserIcon, WebStorage, alertApiRef, appThemeApiRef, auth0AuthApiRef, configApiRef, createApiFactory, createApiRef, createPlugin, createRouteRef, defaultSystemIcons, errorApiRef, featureFlagsApiRef, githubAuthApiRef, gitlabAuthApiRef, googleAuthApiRef, identityApiRef, microsoftAuthApiRef, oauth2ApiRef, oauthRequestApiRef, oktaAuthApiRef, storageApiRef, useApi, useApiHolder, useApp };
